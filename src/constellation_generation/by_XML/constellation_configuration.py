...
def constellation_configuration(dT, constellation_name):
    ...
    constellation_configuration_information = xml_utils.read_xml_file(xml_file_path)
    ...
    file_path = data_directory + constellation_name + ".h5"
    ...
    for count in range(1, number_of_shells + 1, 1):
        ...
        number_of_satellite_per_orbit = int(constellation_configuration_information['constellation']['shell' + str(count)]['number_of_satellite_per_orbit'])
        ...
        for orbit_index in range(1, number_of_orbit + 1, 1):
            # traverse the satellites in each orbit, satellite_index starts from 1
            for satellite_index in range(1, number_of_satellite_per_orbit + 1, 1):
                ...
                satellite.id = (orbit_index - 1) * number_of_satellite_per_orbit + satellite_index
    ...
    target_constellation = constellation.constellation(constellation_name=constellation_name,
                                                       number_of_shells=number_of_shells, shells=shells)
